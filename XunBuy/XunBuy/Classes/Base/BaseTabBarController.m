...
- (void)setupRootViewControllers
{
    ...
    commodityNavContoller.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"所有商品"
    ...
    newFindNavContoller.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"最新揭晓"
    ...
    myCloudBuyNavContoller.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"我的云购"
